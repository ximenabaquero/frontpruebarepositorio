          ...
          <div className="mt-16 bg-gradient-to-r from-[#b659a3] to-[#ad448a] rounded-3xl p-8 sm:p-12 text-white text-center">
            <div className="max-w-3xl mx-auto">
              ...
              <blockquote className="text-xl sm:text-2xl font-light mb-6 leading-relaxed">
                &ldquo;Los resultados superaron todas mis expectativas. El equipo de Perfestetic es increíble y la tecnología realmente funciona. ¡Recomiendo totalmente este tratamiento!&rdquo;
              </blockquote>
