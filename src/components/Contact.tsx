export default function Contact() {
  const socialLinks = [
    ...
    {
      name: 'Instagram',
      href: 'https://instagram.com/perfestetic',
      icon: (
        <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
    ...
    <section className="py-20 bg-gradient-to-br from-gray-50 to-gray-100">
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-4xl mx-auto">
            ...
            {socialLinks.map((link, index) => (
              ...
              >
                <div className="bg-white rounded-2xl p-8 shadow-lg hover:shadow-xl transition-all duration-300 transform hover:-translate-y-2 text-center">
                  ...
                  <div className="inline-flex items-center text-[#9b59b6] font-semibold group-hover:text-[#8e44ad] transition-colors">
                    Contactar
          ...
          {/* Main CTA */}
          <div className="bg-gradient-to-r from-[#9b59b6] to-[#8e44ad] rounded-3xl p-8 sm:p-12 text-white text-center">
            ...
            <div className="flex flex-col sm:flex-row gap-4 justify-center items-center">
              ...
              <a
                href="tel:+1234567890"
                className="bg-white bg-opacity-20 hover:bg-opacity-30 text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 backdrop-blur-sm flex items-center gap-3"
              >
        ...
        <div className="text-center mt-16 pt-8 border-t border-gray-200">
          <div className="mb-4">
            <h3 className="text-2xl font-bold text-[#9b59b6] mb-2">Perfestetic</h3>
