        ...
        <div className="text-center">
          ...
          <div className="mb-8">
            <div className="flex justify-center mb-6">
              <Image 
                ...
                width={300}
                height={200}
                className="h-32 sm:h-40 lg:h-48 w-32 sm:w-40 lg:w-48 object-cover rounded-full shadow-lg"
                priority
              />
            </div>
            <div 
          ...
          <div className="flex justify-center">
            <a
              ...
              className="text-white font-semibold py-4 px-8 rounded-full transition-all duration-300 transform hover:scale-105 shadow-lg flex items-center gap-3 text-lg"
          ...
          <div 
            ...
            style={{ backgroundColor: colors.strongpink, opacity: 0.1 }}
          ></div>
          <div 
