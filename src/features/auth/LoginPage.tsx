                ...
                <div className="p-8 md:p-10">
                  <div className="text-center mb-8">
                    ...
                    <p className="text-gray-600">
                      Ingresa para gestionar contenido, citas y operaciones
                      internas
                    </p>
                  </div>
                ...
                <div className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-xs text-gray-600">
                      Este panel es solo para personal autorizado. Protegemos el
                      acceso con buenas prácticas de seguridad.
                    </p>
                  </div>
                </div>
              </div>
                ...
                <div className="relative z-10">
                  ...
                  <div className="border-t border-white/20 pt-6">
                    <p className="text-emerald-100/80 text-sm">
                      ⚠️ Acceso restringido: solo para administradores y
                      personal autorizado.
                    </p>
                  </div>
                </div>
      ...
      <footer className="mt-12 pt-8 border-t border-gray-100">
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center text-gray-500 text-sm">
            ...
            <p className="mt-1">
              Todos los derechos reservados. Uso autorizado exclusivo.
            </p>
          </div>
        </div>
      </footer>
